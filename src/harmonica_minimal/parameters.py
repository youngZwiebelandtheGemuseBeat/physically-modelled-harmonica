...
DRAW_PARAMETERS = ModelParameters(
    ...
    # Millot reports approximately 230 Pa chamber depression for normal draw.
    # Use a normal-play source magnitude here; the previous 700 Pa default was
    # closer to the cited 635 Pa draw-bend operating point.
