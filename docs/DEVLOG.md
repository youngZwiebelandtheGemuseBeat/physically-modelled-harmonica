...
plateau. It is stable, non-silent, and blow-reed dominant, with output weighted
toward blow-side flow plus a small tract-pressure contribution. The blow reed
periodically enters near closure during the sustained part of the note.

Latest generated metrics:

- draw dominant reed estimate: `draw reed`
- draw fundamental estimate: `444.00 Hz`
- draw harmonic energy ratio: `0.701115`
- draw attack ratio: `0.013433`
- blow dominant reed estimate: `blow reed`
- blow fundamental estimate: `398.00 Hz`
- blow harmonic energy ratio: `0.082648`
- blow attack ratio: `0.006633`
...
Next tuning direction: keep the pressure sign convention fixed and improve tone
quality only through physical parameters, especially brightness, chamber
loading, and vocal-tract coupling.
